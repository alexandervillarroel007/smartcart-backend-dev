...
def registrar_producto(nombre, descripcion, precio, stock, umbral_minimo, umbral_maximo, modelo, id_categoria, imagen):
    conexion = conectar_db()
    if conexion is None:
        return False
    ...
    try:
        cursor = conexion.cursor()
        cursor.execute("""
            INSERT INTO productos (nombre, descripcion, precio, stock, umbral_minimo, umbral_maximo, modelo, id_categoria, imagen)
            VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s)
        """, (nombre, descripcion, precio, stock, umbral_minimo, umbral_maximo, modelo, id_categoria, imagen))
        conexion.commit()
        conexion.close()
        return True
    except Exception as e:
